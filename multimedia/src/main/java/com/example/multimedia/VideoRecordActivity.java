...
public class VideoRecordActivity extends AppCompatActivity implements AutoPermissionsListener {
    ...
    public void stopRecording(){
        ...
        values.put(MediaStore.MediaColumns.ARTIST, "LADY GAGA");
        ...
        //방송 - 녹화가 되었으니 이 파일을 재생할 수 있다고 방송송
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //파일 이름 결정
        //앱의 도큐먼트 디렉토리 경로 가져오기 - 다른 디렉토리에 저장하고 할 때는 이 부분을 수정
    ...
    //동적으로 권한을 요청하고 그 결과를 알려주는 메소드 - AppCompatActivity의 메소드
    @Override
    ...
    //허용한 권한에 대한 정보를 알려주는 메소드 - AutioPermissions의 메소드
    @Override
