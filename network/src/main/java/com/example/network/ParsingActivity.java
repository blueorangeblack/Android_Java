            ...
            public void onClick(View v) {
                new Thread(){
                    ...
                    public void run(){
                        try{
                            //파싱하기 전에 문자열 다운로드
                            URL url = new URL("https://news.daum.net/culture#1");
                            //연결
                ...
                new Thread (){
                    ...
                    public void run(){
                        try{
                            //파싱하기 전에 문자열 다운로드
                            //1) 경제뉴스
                            //URL url = new URL("https://www.hani.co.kr/rss/economy/");
                            //2) 서울,경기 날씨정보
                            ...
                            //1) 경제뉴스 title 태그의 내용을 전부 가져오기
                            //NodeList titles = root.getElementsByTagName("title");

                            //2) 날씨 정보 / 태그 여러개 가져오기
                            NodeList titles = root.getElementsByTagName("wf");
                            NodeList tmEfs = root.getElementsByTagName("tmEf");
                            ...
                            for(int i=0; i<titles.getLength(); i++){
                                ...
                                //날짜 하나 가져오기
                                Node item = tmEfs.item(i);
                                //태그 안의 문자열 가져오기
                                Node contents = item.getFirstChild();
                                String tmEf = contents.getNodeValue();
                                sbResult.append( "날짜:" + tmEf );
                    ...
                    public void run(){
                        try{
                            ...
                            for(int i=0; i<list.length(); i++){
                               ...
                               //title 속성의 내용 가져오기 --> 여러개여도 그냥 추가만 하면 됨
